  ...
  return (
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
      ...
      <div className='flex flex-col h-full w-full justify-center'>
        ...
        <p className='text-2xl py-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. A, maxime.</p>
        <p className='pb-6'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Error dolore labore, odit accusamus non placeat perferendis quod corrupti omnis ad reprehenderit iste! Adipisci animi quibusdam nisi dolorum sunt esse nam?</p>
      </div>
